      ...
      <div className="bg-zinc-800 rounded-lg px-8 py-5 w-full md:w-3/6 lg:w-2/6">
        ...
        <div className="mt-4">
          ...
          <div className="mt-4">
            ...
            <p className="text-zinc-400 flex items-center justify-center">Already have account? <Link to="/Login" className="underline ml-4 hover:text-blue-200 transition-all duration-300">Login</Link></p>
          </div>
        </div>
      </div>
    </div>
